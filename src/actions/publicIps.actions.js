  ...
  return dispatch => {
    return new Promise((resolve, reject) => {
      ...
      provider.create(body).then(
        ...
        toast.error(generateErrorMessage(errorTypes.CREATE, orderTypes.PUBLIC_IP));
  ...
  return dispatch => {
    return new Promise((resolve, reject) => {
      ...
      provider.get().then(
        ...
        toast.error(generateErrorMessage(errorTypes.GET, orderTypes.PUBLIC_IP));
        return reject(dispatch(failure(error)));
      });
    });
  };
  ...
  return dispatch => {
    return new Promise((resolve, reject) => {
      ...
      provider.getData(id).then(
        ...
        toast.error(generateErrorMessage(errorTypes.DATA, orderTypes.PUBLIC_IP, id));
        return reject(dispatch(failure(error)));
      });
    });
  };
  ...
  return dispatch => {
    return new Promise((resolve, reject) => {
      ...
      provider.delete(id).then(
        ...
        toast.error(generateErrorMessage(errorTypes.DELETE, orderTypes.PUBLIC_IP, id));
        return reject(dispatch(failure(error)));
      });
    });
  };
